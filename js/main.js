...
const defaultProducts = [
    ...
    { name: 'Conjunto Plus Branco', price: 150.00, description: 'Top branco + legging preta plus size, costas nadador e conforto total', images: ['assets/products/conjunto-plus-branco-1.jpeg','assets/products/conjunto-plus-branco-2.jpeg'], category: 'plus', colors: [{name:'Branco',hex:'#ffffff',stock:1},{name:'Preto',hex:'#000000',stock:1}] },
    ...
    // ===== TAMANHO ÚNICO (36/42) =====
    { name: 'Conjunto Bege Short', price: 100.00, description: 'Top + short bege, visual clean e elegante para treino', images: ['assets/products/conjunto-bege-short-1.jpeg','assets/products/conjunto-bege-short-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Branco',hex:'#ffffff',stock:1}] },
    ...
    { name: 'Macaquinho Marsala', price: 115.00, description: 'Macaquinho cor marsala texturizado com detalhe nas costas', images: ['assets/products/macaquinho-marsala-1.jpeg','assets/products/macaquinho-marsala-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Vermelho',hex:'#dc2626',stock:1}] },
    ...
    { name: 'Conjunto Bege Cropped', price: 125.00, description: 'Top cropped + short bege com costas trançadas', images: ['assets/products/conjunto-bege-crop-1.jpeg','assets/products/conjunto-bege-crop-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Branco',hex:'#ffffff',stock:1}] },
    ...
    { name: 'Conjunto Verde e Roxo Short', price: 150.00, description: 'Top + short verde e roxo com bolso lateral, conjunto duas peças', images: ['assets/products/macacao-manga-longa-1.jpeg','assets/products/macacao-manga-longa-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Verde',hex:'#16a34a',stock:1},{name:'Roxo',hex:'#7c3aed',stock:1}] },
    { name: 'Conjunto Bicolor com Viés Branco', price: 125.00, description: 'Conjunto bicolor com viés branco nas bordas, top + short bike. Disponível em preto e azul marinho.', images: ['assets/products/conjunto-marinho-branco-1.jpeg','assets/products/conjunto-marinho-branco-2.jpeg','assets/products/conjunto-preto-branco-1.jpeg','assets/products/conjunto-preto-branco-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Azul Marinho',hex:'#1e3a5f',stock:1},{name:'Preto',hex:'#000000',stock:1},{name:'Branco',hex:'#ffffff',stock:1}] },
