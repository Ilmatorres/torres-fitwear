...
const defaultProducts = [
    ...
    { name: 'Macacão Plus Preto', price: 150.00, description: 'Macacão plus size preto com costas abertas, tecido brilhoso e elegante', images: ['assets/products/conjunto-plus-preto-1.jpeg','assets/products/conjunto-plus-preto-2.jpeg'], category: 'plus', colors: [{name:'Preto',hex:'#000000'}] },
