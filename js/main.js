...
const defaultProducts = [
    ...
    { name: 'Blusa Dryft Plus', price: 65.00, description: 'Blusa dry fit plus size azul em tecido leve e respirável (apenas a blusa, a legging da foto não está incluída)', images: ['assets/products/blusa-dryft-plus-1.jpeg','assets/products/blusa-dryft-plus-2.jpeg','assets/products/blusa-dryft-plus-3.jpeg'], category: 'plus', colors: [{name:'Azul',hex:'#6f7fb0',stock:1}] },
    ...
    { name: 'Conjunto Amarelo Short', price: 139.00, description: 'Top + short bike na cor amarelo, vibrante e elegante, tecido premium', images: ['assets/products/conjunto-dourado-1.jpeg'], category: 'tamanho-unico', colors: [{name:'Amarelo',hex:'#f5b800',stock:1}] },
    { name: 'Conjunto Amarelo Manteiga Legging', price: 149.00, description: 'Top + legging na cor amarelo manteiga, visual sofisticado e confortável', images: ['assets/products/conjunto-creme-1.jpeg','assets/products/conjunto-creme-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Amarelo Manteiga',hex:'#f5e8a8',stock:1}] },
    ...
    { name: 'Conjunto Bicolor com Viés Branco', price: 125.00, description: 'Conjunto bicolor com viés branco nas bordas, top + short bike. Disponível em duas combinações: preto e branco ou azul marinho e branco.', images: ['assets/products/conjunto-marinho-branco-1.jpeg','assets/products/conjunto-marinho-branco-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Preto e Branco',hex:'linear-gradient(90deg,#000000 50%,#ffffff 50%)',stock:1},{name:'Azul Marinho e Branco',hex:'linear-gradient(90deg,#1e3a5f 50%,#ffffff 50%)',stock:1}] },
...
const FEEDBACK_IMAGES = [
    ...
    "assets/feedback/cliente-4.jpeg",
    "assets/feedback/cliente-5.jpeg",
    "assets/feedback/cliente-6.jpeg",
    "assets/feedback/cliente-7.jpeg",
    "assets/feedback/cliente-8.jpeg",
