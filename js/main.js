...
const defaultProducts = [
    ...
    { name: 'Conjunto Marinho Texturizado', price: 115.00, description: 'Top + legging azul marinho texturizado com costas abertas, conjunto duas peças', images: ['assets/products/macaquinho-marinho-1.jpeg','assets/products/macaquinho-marinho-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Azul Marinho',hex:'#1e3a5f'}] },
