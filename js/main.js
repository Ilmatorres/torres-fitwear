...
const defaultProducts = [
    ...
    { name: 'Blusa Dryft Plus', price: 65.00, description: 'Blusa dry fit plus size em tecido leve e respirável (apenas a blusa, a legging da foto não está incluída)', images: ['assets/products/blusa-dryft-plus-1.jpeg','assets/products/blusa-dryft-plus-2.jpeg','assets/products/blusa-dryft-plus-3.jpeg'], category: 'plus', colors: [{name:'Amarelo Manteiga',hex:'#f5e8a8',stock:1}] },
