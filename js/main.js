...
const defaultProducts = [
    ...
    { name: 'Conjunto Plus Preto', price: 150.00, description: 'Top + legging plus size preto, tecido brilhoso e elegante', images: ['assets/products/conjunto-plus-preto-1.jpeg','assets/products/conjunto-plus-preto-2.jpeg'], category: 'plus', colors: [{name:'Preto',hex:'#000000'}] },
    ...
    { name: 'Conjunto Dourado', price: 139.00, description: 'Top + short bike dourado, cor vibrante e tecido premium', images: ['assets/products/conjunto-dourado-1.jpeg'], category: 'tamanho-unico', colors: [{name:'Amarelo',hex:'#d4a017'}] },
    ...
    { name: 'Conjunto Chumbo', price: 190.00, description: 'Regata + legging chumbo com detalhe branco, estilo esportivo', images: ['assets/products/conjunto-chumbo-1.jpeg','assets/products/conjunto-chumbo-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Cinza',hex:'#6b7280'}] },
    ...
    { name: 'Macaquinho Preto Animal Print', price: 115.00, description: 'Macaquinho preto com textura animal print, costas abertas e alças cruzadas', images: ['assets/products/macaquinho-marinho-1.jpeg','assets/products/macaquinho-marinho-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Preto',hex:'#000000'}] },
    ...
    { name: 'Macaquinho Preto Cruzado', price: 150.00, description: 'Macaquinho preto curto com costas cruzadas, visual poderoso e versátil', images: ['assets/products/macacao-preto-1.jpeg','assets/products/macacao-preto-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Preto',hex:'#000000'}] },
    ...
    { name: 'Conjunto Marinho Zebra', price: 150.00, description: 'Conjunto azul marinho com textura zebra, top + legging com costas abertas, conjunto duas peças', images: ['assets/products/macacao-sage-1.jpeg','assets/products/macacao-sage-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Azul Marinho',hex:'#1e3a5f'}] },
    ...
    { name: 'Conjunto Verde Esmeralda', price: 139.00, description: 'Top + short verde esmeralda, estilo moderno e elegante', images: ['assets/products/conjunto-bicolor-1.jpeg','assets/products/conjunto-bicolor-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Verde Esmeralda',hex:'#10b981'}] },
    { name: 'Conjunto Verde e Roxo Short', price: 150.00, description: 'Top + short verde e roxo com bolso lateral, conjunto duas peças', images: ['assets/products/macacao-manga-longa-1.jpeg','assets/products/macacao-manga-longa-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Verde',hex:'#16a34a'},{name:'Roxo',hex:'#7c3aed'}] },
    { name: 'Conjunto Bicolor com Viés Branco', price: 125.00, description: 'Conjunto bicolor com viés branco nas bordas, top + short bike. Disponível em preto e azul marinho.', images: ['assets/products/conjunto-marinho-branco-1.jpeg','assets/products/conjunto-marinho-branco-2.jpeg','assets/products/conjunto-preto-branco-1.jpeg','assets/products/conjunto-preto-branco-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Azul Marinho',hex:'#1e3a5f'},{name:'Preto',hex:'#000000'},{name:'Branco',hex:'#ffffff'}] },
    { name: 'Conjunto Preto', price: 110.00, description: 'Conjunto preto top + legging, modelagem clássica para treino e dia a dia', images: ['assets/products/conjunto-preto-novo-1.jpeg','assets/products/conjunto-preto-novo-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Preto',hex:'#000000'}] },
    { name: 'Conjunto Canelado Marsala', price: 110.00, description: 'Conjunto canelado top + short na cor marsala, tecido com textura e caimento perfeito', images: ['assets/products/conjunto-canelado-marsala-1.jpeg'], category: 'tamanho-unico', colors: [{name:'Marsala',hex:'#9b2c4f'}] },
    { name: 'Conjunto Canelado Marinho', price: 110.00, description: 'Conjunto canelado top + short azul marinho, tecido com textura canelada elegante', images: ['assets/products/conjunto-canelado-marinho-1.jpeg'], category: 'tamanho-unico', colors: [{name:'Azul Marinho',hex:'#1e3a5f'}] },
    { name: 'Short Canelado', price: 55.00, description: 'Short bike canelado, tecido com textura. Disponível em várias cores: bege, azul marinho, marsala, branco e oliva', images: ['assets/products/short-canelado-1.jpeg','assets/products/short-canelado-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Bege',hex:'#d4b896'},{name:'Azul Marinho',hex:'#1e3a5f'},{name:'Marsala',hex:'#9b2c4f'},{name:'Branco',hex:'#ffffff'},{name:'Verde Oliva',hex:'#808000'}] },
    ...
    { name: 'Blusa Verde Neon', price: 50.00, description: 'Blusa verde neon, modelo solto e leve para treino', images: ['assets/products/blusa-verde-neon-1.jpeg'], category: 'blusas', colors: [{name:'Verde Neon',hex:'#84cc16'}] },
    { name: 'Blusa Branca', price: 50.00, description: 'Blusa branca leve e respirável, perfeita para o dia a dia e treino', images: ['assets/products/blusa-branca-1.jpeg','assets/products/blusa-branca-2.jpeg'], category: 'blusas', colors: [{name:'Branco',hex:'#ffffff'}] },
    { name: 'Blusa Azul', price: 50.00, description: 'Regata azul com tecido leve e respirável, ideal para treinos', images: ['assets/products/blusa-azul-1.jpeg','assets/products/blusa-azul-2.jpeg'], category: 'blusas', colors: [{name:'Azul',hex:'#3b82f6'}] },
