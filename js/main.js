...
const defaultProducts = [
    ...
    { name: 'Conjunto Amarelo Manteiga Short', price: 139.00, description: 'Top + short bike na cor amarelo manteiga, suave e elegante, tecido premium', images: ['assets/products/conjunto-dourado-1.jpeg'], category: 'tamanho-unico', colors: [{name:'Amarelo Manteiga',hex:'#f5e8a8',stock:1}] },
