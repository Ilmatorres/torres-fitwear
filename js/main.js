...
const defaultProducts = [
    ...
    { name: 'Conjunto Plus Vermelho', price: 159.00, description: 'Top + legging plus size vermelho marsala, cintura alta e costas trançadas', images: ['assets/products/conjunto-plus-vermelho-1.jpeg','assets/products/conjunto-plus-vermelho-2.jpeg'], category: 'plus', colors: [{name:'Vermelho',hex:'#dc2626',stock:5}] },
    { name: 'Conjunto Plus Verde', price: 149.00, description: 'Top + legging plus size verde esmeralda, tecido brilhoso e compressão leve', images: ['assets/products/conjunto-plus-verde-1.jpeg','assets/products/conjunto-plus-verde-2.jpeg'], category: 'plus', colors: [{name:'Verde',hex:'#16a34a',stock:5}] },
    { name: 'Blusa Dryft Plus', price: 65.00, description: 'Blusa dry fit plus size azul com legging roxa, tecido leve e respirável', images: ['assets/products/blusa-dryft-plus-1.jpeg','assets/products/blusa-dryft-plus-2.jpeg','assets/products/blusa-dryft-plus-3.jpeg'], category: 'plus', colors: [{name:'Azul',hex:'#2563eb',stock:5},{name:'Roxo',hex:'#7c3aed',stock:5}] },
    { name: 'Conjunto Plus Preto', price: 150.00, description: 'Top + legging plus size preto, tecido brilhoso e elegante', images: ['assets/products/conjunto-plus-preto-1.jpeg','assets/products/conjunto-plus-preto-2.jpeg'], category: 'plus', colors: [{name:'Preto',hex:'#000000',stock:5}] },
    { name: 'Tule Plus', price: 59.00, description: 'Blusa tule plus size azul marinho com detalhe transparente na cintura', images: ['assets/products/tule-plus-1.jpeg','assets/products/tule-plus-2.jpeg'], category: 'plus', colors: [{name:'Azul Marinho',hex:'#1e3a5f',stock:5}] },
    { name: 'Conjunto Plus Branco', price: 150.00, description: 'Top branco + legging preta plus size, costas nadador e conforto total', images: ['assets/products/conjunto-plus-branco-1.jpeg','assets/products/conjunto-plus-branco-2.jpeg'], category: 'plus', colors: [{name:'Branco',hex:'#ffffff',stock:5},{name:'Preto',hex:'#000000',stock:5}] },
    { name: 'Conjunto Plus Short', price: 135.00, description: 'Regata + short bike plus size preto, perfeito para treino e dia a dia', images: ['assets/products/conjunto-plus-short-1.jpeg','assets/products/conjunto-plus-short-2.jpeg'], category: 'plus', colors: [{name:'Preto',hex:'#000000',stock:5}] },

    // ===== TAMANHO ÚNICO (36/42) =====
    { name: 'Conjunto Bege Short', price: 100.00, description: 'Top + short bege, visual clean e elegante para treino', images: ['assets/products/conjunto-bege-short-1.jpeg','assets/products/conjunto-bege-short-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Branco',hex:'#ffffff',stock:5}] },
    { name: 'Conjunto Cinza', price: 115.00, description: 'Top cropped + legging cinza, tecido macio e confortável', images: ['assets/products/conjunto-cinza-1.jpeg','assets/products/conjunto-cinza-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Cinza',hex:'#6b7280',stock:5}] },
    { name: 'Conjunto Azul Claro', price: 149.00, description: 'Top + legging azul claro, tecido brilhoso com compressão leve', images: ['assets/products/conjunto-azul-claro-1.jpeg','assets/products/conjunto-azul-claro-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Azul',hex:'#2563eb',stock:5}] },
    { name: 'Conjunto Azul Royal', price: 125.00, description: 'Top triângulo + short azul royal, estilo praiano fitness', images: ['assets/products/conjunto-azul-royal-1.jpeg','assets/products/conjunto-azul-royal-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Azul',hex:'#2563eb',stock:5}] },
    { name: 'Conjunto Dourado', price: 139.00, description: 'Top + short bike dourado, cor vibrante e tecido premium', images: ['assets/products/conjunto-dourado-1.jpeg'], category: 'tamanho-unico', colors: [{name:'Amarelo',hex:'#d4a017',stock:5}] },
    { name: 'Conjunto Creme', price: 149.00, description: 'Top + legging creme, visual sofisticado e confortável', images: ['assets/products/conjunto-creme-1.jpeg','assets/products/conjunto-creme-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Branco',hex:'#ffffff',stock:5}] },
    { name: 'Conjunto Oliva Short', price: 100.00, description: 'Top cropped + short bike verde oliva, tecido canelado', images: ['assets/products/conjunto-oliva-1.jpeg','assets/products/conjunto-oliva-2.jpeg','assets/products/conjunto-oliva-3.jpeg'], category: 'tamanho-unico', colors: [{name:'Verde',hex:'#16a34a',stock:5}] },
    { name: 'Macaquinho Rosa', price: 115.00, description: 'Macaquinho rosa claro com detalhe nas costas trançado', images: ['assets/products/macaquinho-rosa-1.jpeg','assets/products/macaquinho-rosa-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Rosa',hex:'#e91e8c',stock:5}] },
    { name: 'Conjunto Chumbo', price: 190.00, description: 'Regata + legging chumbo com detalhe branco, estilo esportivo', images: ['assets/products/conjunto-chumbo-1.jpeg','assets/products/conjunto-chumbo-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Cinza',hex:'#6b7280',stock:5}] },
    { name: 'Macacão Verde Água', price: 150.00, description: 'Macacão menta/verde água com costas abertas cruzadas, peça única elegante', images: ['assets/products/macacao-verde-agua-1.jpeg','assets/products/macacao-verde-agua-2.jpeg','assets/products/macacao-verde-agua-3.jpeg'], category: 'tamanho-unico', colors: [{name:'Verde Água',hex:'#2dd4bf',stock:5}] },
    { name: 'Macaquinho Preto Animal Print', price: 115.00, description: 'Macaquinho preto com textura animal print, costas abertas e alças cruzadas', images: ['assets/products/macaquinho-marinho-1.jpeg','assets/products/macaquinho-marinho-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Preto',hex:'#000000',stock:5}] },
    { name: 'Macaquinho Marsala', price: 115.00, description: 'Macaquinho cor marsala texturizado com detalhe nas costas', images: ['assets/products/macaquinho-marsala-1.jpeg','assets/products/macaquinho-marsala-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Vermelho',hex:'#dc2626',stock:5}] },
    { name: 'Conjunto Marinho', price: 139.00, description: 'Top + legging azul marinho com costas abertas, clássico e elegante', images: ['assets/products/conjunto-marinho-1.jpeg','assets/products/conjunto-marinho-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Azul Marinho',hex:'#1e3a5f',stock:5}] },
    { name: 'Macaquinho Preto Cruzado', price: 150.00, description: 'Macaquinho preto curto com costas cruzadas, visual poderoso e versátil', images: ['assets/products/macacao-preto-1.jpeg','assets/products/macacao-preto-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Preto',hex:'#000000',stock:5}] },
    { name: 'Conjunto Bege Cropped', price: 125.00, description: 'Top cropped + short bege com costas trançadas', images: ['assets/products/conjunto-bege-crop-1.jpeg','assets/products/conjunto-bege-crop-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Branco',hex:'#ffffff',stock:5}] },
    { name: 'Conjunto Marinho Zebra', price: 150.00, description: 'Conjunto azul marinho com textura zebra, top + legging com costas abertas, conjunto duas peças', images: ['assets/products/macacao-sage-1.jpeg','assets/products/macacao-sage-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Azul Marinho',hex:'#1e3a5f',stock:5}] },
    { name: 'Macaquinho Menta', price: 115.00, description: 'Macaquinho menta/verde claro com costas cruzadas', images: ['assets/products/macaquinho-menta-1.jpeg','assets/products/macaquinho-menta-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Verde Água',hex:'#2dd4bf',stock:5}] },
    { name: 'Conjunto Verde Esmeralda', price: 139.00, description: 'Top + short verde esmeralda, estilo moderno e elegante', images: ['assets/products/conjunto-bicolor-1.jpeg','assets/products/conjunto-bicolor-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Verde Esmeralda',hex:'#10b981',stock:5}] },
    { name: 'Conjunto Verde e Roxo Short', price: 150.00, description: 'Top + short verde e roxo com bolso lateral, conjunto duas peças', images: ['assets/products/macacao-manga-longa-1.jpeg','assets/products/macacao-manga-longa-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Verde',hex:'#16a34a',stock:5},{name:'Roxo',hex:'#7c3aed',stock:5}] },
    { name: 'Conjunto Bicolor com Viés Branco', price: 125.00, description: 'Conjunto bicolor com viés branco nas bordas, top + short bike. Disponível em preto e azul marinho.', images: ['assets/products/conjunto-marinho-branco-1.jpeg','assets/products/conjunto-marinho-branco-2.jpeg','assets/products/conjunto-preto-branco-1.jpeg','assets/products/conjunto-preto-branco-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Azul Marinho',hex:'#1e3a5f',stock:5},{name:'Preto',hex:'#000000',stock:5},{name:'Branco',hex:'#ffffff',stock:5}] },
    { name: 'Conjunto Preto', price: 110.00, description: 'Conjunto preto top + legging, modelagem clássica para treino e dia a dia', images: ['assets/products/conjunto-preto-novo-1.jpeg','assets/products/conjunto-preto-novo-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Preto',hex:'#000000',stock:5}] },
    { name: 'Conjunto Canelado Marsala', price: 110.00, description: 'Conjunto canelado top + short na cor marsala, tecido com textura e caimento perfeito', images: ['assets/products/conjunto-canelado-marsala-1.jpeg'], category: 'tamanho-unico', colors: [{name:'Marsala',hex:'#9b2c4f',stock:5}] },
    { name: 'Conjunto Canelado Marinho', price: 110.00, description: 'Conjunto canelado top + short azul marinho, tecido com textura canelada elegante', images: ['assets/products/conjunto-canelado-marinho-1.jpeg'], category: 'tamanho-unico', colors: [{name:'Azul Marinho',hex:'#1e3a5f',stock:5}] },
    { name: 'Short Canelado', price: 55.00, description: 'Short bike canelado, tecido com textura. Disponível em várias cores: bege, azul marinho, marsala, branco e oliva', images: ['assets/products/short-canelado-1.jpeg','assets/products/short-canelado-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Bege',hex:'#d4b896',stock:5},{name:'Azul Marinho',hex:'#1e3a5f',stock:5},{name:'Marsala',hex:'#9b2c4f',stock:5},{name:'Branco',hex:'#ffffff',stock:5},{name:'Verde Oliva',hex:'#808000',stock:5}] },

    // ===== BLUSAS =====
    { name: 'Blusa Tule Azul', price: 44.99, description: 'Regata em tule azul claro, leve e transparente, perfeita para usar sobre o top no treino', images: ['assets/products/blusa-tule-azul-1.jpeg','assets/products/blusa-tule-azul-2.jpeg'], category: 'blusas', colors: [{name:'Azul',hex:'#87CEEB',stock:5}] },
    { name: 'Blusa Tule Verde Oliva', price: 44.99, description: 'Regata em tule verde oliva, transparência estilosa e caimento solto', images: ['assets/products/blusa-tule-verde-1.jpeg','assets/products/blusa-tule-verde-2.jpeg'], category: 'blusas', colors: [{name:'Verde',hex:'#808000',stock:5}] },
    { name: 'Blusa Tule Manga Longa', price: 59.90, description: 'Blusa tule manga longa preta, transparência elegante para usar no dia a dia ou no treino', images: ['assets/products/blusa-tule-manga-longa-1.jpeg'], category: 'blusas', colors: [{name:'Preto',hex:'#000000',stock:5}] },
    { name: 'Cropt Tule Pink', price: 39.90, description: 'Cropped tule na cor pink, transparente e estiloso, perfeito para o treino', images: ['assets/products/cropt-tule-pink-1.jpeg'], category: 'blusas', colors: [{name:'Pink',hex:'#ec4899',stock:5}] },
    { name: 'Blusa UV Turquesa', price: 49.00, description: 'Blusa com proteção UV e secagem rápida, recorte nas costas, ideal para treinos ao ar livre', images: ['assets/products/blusa-uv-1.jpeg','assets/products/blusa-uv-2.jpeg','assets/products/blusa-uv-3.jpeg'], category: 'blusas', colors: [{name:'Verde Água',hex:'#2dd4bf',stock:5}] },
    { name: 'Blusa Tule Plus Marinho', price: 49.90, description: 'Blusa tule plus size azul marinho, detalhe transparente na cintura, moderna e confortável', images: ['assets/products/blusa-tule-plus-1.jpeg','assets/products/blusa-tule-plus-2.jpeg'], category: 'blusas', colors: [{name:'Azul Marinho',hex:'#1e3a5f',stock:5}] },
    { name: 'Blusa Dryft', price: 59.90, description: 'Blusa dry fit azul, tecido tecnológico com secagem rápida e toque macio', images: ['assets/products/blusa-dryft-1.jpeg','assets/products/blusa-dryft-2.jpeg'], category: 'blusas', colors: [{name:'Azul',hex:'#6B7FA0',stock:5}] },
    { name: 'Blusa Verde Neon', price: 50.00, description: 'Blusa verde neon, modelo solto e leve para treino', images: ['assets/products/blusa-verde-neon-1.jpeg'], category: 'blusas', colors: [{name:'Verde Neon',hex:'#84cc16',stock:5}] },
    { name: 'Blusa Branca', price: 50.00, description: 'Blusa branca leve e respirável, perfeita para o dia a dia e treino', images: ['assets/products/blusa-branca-1.jpeg','assets/products/blusa-branca-2.jpeg'], category: 'blusas', colors: [{name:'Branco',hex:'#ffffff',stock:5}] },
    { name: 'Blusa Azul', price: 50.00, description: 'Regata azul com tecido leve e respirável, ideal para treinos', images: ['assets/products/blusa-azul-1.jpeg','assets/products/blusa-azul-2.jpeg'], category: 'blusas', colors: [{name:'Azul',hex:'#3b82f6',stock:5}] },

    // ===== JAQUETAS =====
    { name: 'Jaqueta Corta-Vento', price: 99.90, description: 'Jaqueta corta-vento com capuz e zíper, leve e respirável, perfeita para treinos ao ar livre. Disponível em 4 cores.', images: ['assets/products/jaqueta-corta-vento-1.jpeg','assets/products/jaqueta-corta-vento-2.jpeg','assets/products/jaqueta-corta-vento-3.jpeg','assets/products/jaqueta-corta-vento-4.jpeg','assets/products/jaqueta-corta-vento-5.jpeg'], category: 'jaquetas', colors: [{name:'Preto',hex:'#000000',stock:5},{name:'Branco',hex:'#ffffff',stock:5},{name:'Bege',hex:'#d4b896',stock:5},{name:'Rosa',hex:'#f4a8b0',stock:5}] }
];
