...
const defaultProducts = [
    ...
    { name: 'Conjunto Marinho Detalhe Branco', price: 125.00, description: 'Conjunto bicolor azul marinho e branco, top + short bike com viés branco nas bordas', images: ['assets/products/conjunto-marinho-branco-1.jpeg','assets/products/conjunto-marinho-branco-2.jpeg'], category: 'tamanho-unico', colors: [{name:'Azul Marinho',hex:'#1e3a5f'},{name:'Branco',hex:'#ffffff'}] },
